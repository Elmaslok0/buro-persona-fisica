...
export default function Prospector() {
  ...
  const prospector = trpc.buro.prospector.useMutation({
    onSuccess: (data) => {
      toast.success("Análisis de prospección completado");
      setResult(data);
      setShowResult(true);
    },
    onError: (error) => {
      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="container py-12">
          <Card className="border-4 border-black p-8">
            <h2 className="text-3xl font-black uppercase mb-6">ANÁLISIS DE PROSPECCIÓN</h2>
        ...
        <Card className="border-4 border-black p-8 max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-lg font-bold">
              Análisis y prospección de clientes potenciales basado en su perfil crediticio.
              Evalúa el comportamiento de pago, capacidad crediticia, productos financieros activos
              y genera recomendaciones para ofertas personalizadas de crédito.
            </p>
          </div>
            ...
            {clientId && client && (
              <>
                ...
                <div className="border-4 border-black p-6 bg-accent">
                  <h3 className="text-2xl font-black uppercase mb-4">ANÁLISIS INCLUIDO</h3>
                  <ul className="space-y-2 text-lg font-bold">
                    <li>• Perfil crediticio completo</li>
                    <li>• Comportamiento de pago histórico</li>
                    <li>• Capacidad de endeudamiento</li>
                    <li>• Productos financieros activos</li>
                    <li>• Score crediticio</li>
                    <li>• Recomendaciones de productos</li>
                    <li>• Probabilidad de aprobación</li>
                  </ul>
                </div>
                ...
                <div className="flex gap-4 pt-6">
                  ...
                  <Button
                    ...
                    size="lg"
                    className="flex-1 text-2xl font-black uppercase border-4 border-black"
                    disabled={prospector.isPending}
                  >
                    {prospector.isPending ? "ANALIZANDO..." : "ANALIZAR CLIENTE"}
                  </Button>
                </div>
              </>
            )}
